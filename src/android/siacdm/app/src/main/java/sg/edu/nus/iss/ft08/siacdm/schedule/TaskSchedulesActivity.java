...
public class TaskSchedulesActivity extends SiaCdmBaseActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.activity_task_schedules);
    initCommonUi();
  }
  ...
  protected void onPostCreate(@Nullable Bundle savedInstanceState) {
    ...
    ControlFactory.getSchedulesController().onDisplayTargetTask(this);
  }
